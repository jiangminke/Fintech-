var puzzle = function () {
  ...
  var build = function (conf, callbak) {
      ...
      if (xqo[i].type === "SECONDARY_IMG") {
        ...
        img_sec.onload = function () {
          ctx.drawImage(
            ...
            originX,
            originY,
            conf.captchaData.params.jigsawWidth,
            conf.captchaData.params.jigsawHight
          );
        };
      }
    }
    ...
    var btnCtx = function (offX, move, loading) {
      ...
      ctx2.lineTo(
        tt + conf.captchaData.params.jigsawWidth - 18,
        tipHeight / 2 + 4
      );
    ...
    canvas2.onmousedown = function (e) {
      ...
      window.onmousemove = function (e) {
        ...
        finalX = canvasHover ? e.offsetX : e.offsetX - beginClientX;
        chkX();
