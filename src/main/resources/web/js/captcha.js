var captcha = function () {
  ...
  var unit = (function () {
    ...
    var T8T = {};
    T8T.F8N = function () {
      return typeof T8T.V8N.m9p === "function"
        ? T8T.V8N.m9p.apply(T8T.V8N, arguments)
        : T8T.V8N.m9p;
    };

    T8T.AB8 = function () {
      return typeof T8T.YU0.atx === "function"
        ? T8T.YU0.atx.apply(T8T.YU0, arguments)
        : T8T.YU0.atx;
    };
          ...
          while (S3d !== 14) {
            switch (S3d) {
              ...
              case 8:
                ...
                break;
              case 9:
                F1f += win[T8T.AB8(5)][T8T.AB8(3)](
                  W1f[T8T.AB8(4)](X1f) ^ w3d[T8T.AB8(4)](B1f)
                );
                S3d = 8;
                break;
              case 7:
    ...
    var _img_make = function (ctx, conf) {
      ...
      for (var i = T8T.F8N(82); i < dat.size - 1; i++) {
        ImageData = ctx[T8T.F8N(0)](
          dat.get(i.toString()) * wegiht,
          T8T.F8N(82),
          wegiht,
          h
        );
